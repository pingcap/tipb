...
pub struct ExecutorExecutionSummary {
    // message fields
    total_time_ms: ::std::option::Option<u64>,
    produced_rows: ::std::option::Option<u64>,
    next_calls: ::std::option::Option<u64>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl ExecutorExecutionSummary {
    ...
    // optional uint64 total_time_ms = 1;
    ...
    // Param is passed by value, moved
    pub fn set_total_time_ms(&mut self, v: u64) {
    ...
    // optional uint64 produced_rows = 2;

    pub fn clear_produced_rows(&mut self) {
        self.produced_rows = ::std::option::Option::None;
    }

    pub fn has_produced_rows(&self) -> bool {
        self.produced_rows.is_some()
    }

    // Param is passed by value, moved
    pub fn set_produced_rows(&mut self, v: u64) {
        self.produced_rows = ::std::option::Option::Some(v);
    }

    pub fn get_produced_rows(&self) -> u64 {
        self.produced_rows.unwrap_or(0)
    }

    // optional uint64 next_calls = 3;

    pub fn clear_next_calls(&mut self) {
        self.next_calls = ::std::option::Option::None;
    }

    pub fn has_next_calls(&self) -> bool {
        self.next_calls.is_some()
    }

    // Param is passed by value, moved
    pub fn set_next_calls(&mut self, v: u64) {
        self.next_calls = ::std::option::Option::Some(v);
    }

    pub fn get_next_calls(&self) -> u64 {
        self.next_calls.unwrap_or(0)
    }
}
...
impl ::protobuf::Message for ExecutorExecutionSummary {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    let tmp = is.read_uint64()?;
                    self.produced_rows = ::std::option::Option::Some(tmp);
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_uint64()?;
                    self.next_calls = ::std::option::Option::Some(tmp);
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.produced_rows {
            my_size += ::protobuf::rt::value_size(2, v, ::protobuf::wire_format::WireTypeVarint);
        }
        if let Some(v) = self.next_calls {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "total_time_ms",
                    |m: &ExecutorExecutionSummary| { &m.total_time_ms },
                    |m: &mut ExecutorExecutionSummary| { &mut m.total_time_ms },
                ));
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "produced_rows",
                    |m: &ExecutorExecutionSummary| { &m.produced_rows },
                    |m: &mut ExecutorExecutionSummary| { &mut m.produced_rows },
                ));
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "next_calls",
                    |m: &ExecutorExecutionSummary| { &m.next_calls },
                    |m: &mut ExecutorExecutionSummary| { &mut m.next_calls },
                ));
...
impl ::protobuf::Clear for ExecutorExecutionSummary {
    fn clear(&mut self) {
        ...
        self.clear_produced_rows();
        self.clear_next_calls();
        self.unknown_fields.clear();
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1a\n\x05limit\x18\x01\x20\x01(\x04R\x05limitB\x04\xc8\xde\x1f\0\"\x82\
    \x01\n\x18ExecutorExecutionSummary\x12\"\n\rtotal_time_ms\x18\x01\x20\
    \x01(\x04R\x0btotalTimeMs\x12#\n\rproduced_rows\x18\x02\x20\x01(\x04R\
    \x0cproducedRows\x12\x1d\n\nnext_calls\x18\x03\x20\x01(\x04R\tnextCalls*\
    \x88\x01\n\x08ExecType\x12\x11\n\rTypeTableScan\x10\0\x12\x11\n\rTypeInd\
    exScan\x10\x01\x12\x11\n\rTypeSelection\x10\x02\x12\x13\n\x0fTypeAggrega\
    tion\x10\x03\x12\x0c\n\x08TypeTopN\x10\x04\x12\r\n\tTypeLimit\x10\x05\
    \x12\x11\n\rTypeStreamAgg\x10\x06B%\n\x15com.pingcap.tidb.tipbP\x01\xe0\
    \xe2\x1e\x01\xd0\xe2\x1e\x01\xc8\xe2\x1e\x01J\xe9!\n\x06\x12\x04\0\0Z\
    ...
    \x03Q\x08\x20\n`\n\x04\x04\x08\x02\0\x12\x03S\x08*\x1aS\x20Total\x20time\
    ...
    \x04\x08\x02\0\x01\x12\x03S\x18%\n\x0c\n\x05\x04\x08\x02\0\x03\x12\x03S(\
    )\n<\n\x04\x04\x08\x02\x01\x12\x03V\x08*\x1a/\x20How\x20many\x20rows\x20\
    ...
    \x03\x12\x03V()\n<\n\x04\x04\x08\x02\x02\x12\x03Y\x08'\x1a/\x20How\x20ma\
