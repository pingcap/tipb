...
impl ::protobuf::ProtobufEnum for ExprType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ExprType> {
        match value {
            ...
            3019 => ::std::option::Option::Some(ExprType::JsonObjectAggr),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ipbP\x01\xe0\xe2\x1e\x01\xc8\xe2\x1e\x01\xd0\xe2\x1e\x01J\xd5\xc9\x01\n\
