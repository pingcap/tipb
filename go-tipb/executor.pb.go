...
type ANNQueryInfo struct {
	...
	PushedDownProjections []Expr               `protobuf:"bytes,20,rep,name=pushed_down_projections,json=pushedDownProjections" json:"pushed_down_projections"`
	MaxDistance           float64              `protobuf:"fixed64,50,opt,name=max_distance,json=maxDistance" json:"max_distance"`
	HnswEfSearch          uint32               `protobuf:"varint,100,opt,name=hnsw_ef_search,json=hnswEfSearch" json:"hnsw_ef_search"`
	XXX_unrecognized      []byte               `json:"-"`
}
...
func (m *ANNQueryInfo) GetPushedDownProjections() []Expr {
	if m != nil {
		return m.PushedDownProjections
	}
	return nil
}
...
func (m *ANNQueryInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PushedDownProjections) > 0 {
		for _, msg := range m.PushedDownProjections {
			dAtA[i] = 0xa2
			i++
			dAtA[i] = 0x1
			i++
...
func (m *ANNQueryInfo) Size() (n int) {
	...
	if len(m.PushedDownProjections) > 0 {
		for _, e := range m.PushedDownProjections {
			l = e.Size()
			n += 2 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *ANNQueryInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PushedDownProjections", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PushedDownProjections = append(m.PushedDownProjections, Expr{})
			if err := m.PushedDownProjections[len(m.PushedDownProjections)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 50:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
