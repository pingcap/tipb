...
type TiFlashScanContext struct {
	...
	TotalDmfileRoughSetIndexLoadTimeNs *uint64 `protobuf:"varint,8,opt,name=total_dmfile_rough_set_index_load_time_ns,json=totalDmfileRoughSetIndexLoadTimeNs" json:"total_dmfile_rough_set_index_load_time_ns,omitempty"`
	TotalDmfileReadTimeNs              *uint64 `protobuf:"varint,9,opt,name=total_dmfile_read_time_ns,json=totalDmfileReadTimeNs" json:"total_dmfile_read_time_ns,omitempty"`
	TotalCreateSnapshotTimeNs          *uint64 `protobuf:"varint,10,opt,name=total_create_snapshot_time_ns,json=totalCreateSnapshotTimeNs" json:"total_create_snapshot_time_ns,omitempty"`
	XXX_unrecognized                   []byte  `json:"-"`
}
...
func (m *TiFlashScanContext) GetTotalDmfileRoughSetIndexLoadTimeNs() uint64 {
	if m != nil && m.TotalDmfileRoughSetIndexLoadTimeNs != nil {
		return *m.TotalDmfileRoughSetIndexLoadTimeNs
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalDmfileReadTimeNs() uint64 {
	if m != nil && m.TotalDmfileReadTimeNs != nil {
		return *m.TotalDmfileReadTimeNs
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalCreateSnapshotTimeNs() uint64 {
	if m != nil && m.TotalCreateSnapshotTimeNs != nil {
		return *m.TotalCreateSnapshotTimeNs
	}
	return 0
}
...
func (m *TiFlashScanContext) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TotalDmfileRoughSetIndexLoadTimeNs != nil {
		dAtA[i] = 0x40
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalDmfileRoughSetIndexLoadTimeNs))
	}
	if m.TotalDmfileReadTimeNs != nil {
		dAtA[i] = 0x48
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalDmfileReadTimeNs))
	}
	if m.TotalCreateSnapshotTimeNs != nil {
		dAtA[i] = 0x50
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalCreateSnapshotTimeNs))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *TiFlashScanContext) Size() (n int) {
	...
	if m.TotalDmfileRoughSetIndexLoadTimeNs != nil {
		n += 1 + sovExecutor(uint64(*m.TotalDmfileRoughSetIndexLoadTimeNs))
	}
	if m.TotalDmfileReadTimeNs != nil {
		n += 1 + sovExecutor(uint64(*m.TotalDmfileReadTimeNs))
	}
	if m.TotalCreateSnapshotTimeNs != nil {
		n += 1 + sovExecutor(uint64(*m.TotalCreateSnapshotTimeNs))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *TiFlashScanContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDmfileRoughSetIndexLoadTimeNs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalDmfileRoughSetIndexLoadTimeNs = &v
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDmfileReadTimeNs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalDmfileReadTimeNs = &v
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalCreateSnapshotTimeNs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
