...
type TiFlashScanContext struct {
	...
	FtsLoadFromS3                 *uint32                       `protobuf:"varint,140,opt,name=fts_load_from_s3,json=ftsLoadFromS3" json:"fts_load_from_s3,omitempty"`
	FtsLoadFromDisk               *uint32                       `protobuf:"varint,141,opt,name=fts_load_from_disk,json=ftsLoadFromDisk" json:"fts_load_from_disk,omitempty"`
	FtsLoadFromCache              *uint32                       `protobuf:"varint,142,opt,name=fts_load_from_cache,json=ftsLoadFromCache" json:"fts_load_from_cache,omitempty"`
	FtsLoadTimeMs                 *uint64                       `protobuf:"varint,143,opt,name=fts_load_time_ms,json=ftsLoadTimeMs" json:"fts_load_time_ms,omitempty"`
	FtsMissRowsStable             *uint32                       `protobuf:"varint,144,opt,name=fts_miss_rows_stable,json=ftsMissRowsStable" json:"fts_miss_rows_stable,omitempty"`
	FtsMissRowsDelta              *uint32                       `protobuf:"varint,145,opt,name=fts_miss_rows_delta,json=ftsMissRowsDelta" json:"fts_miss_rows_delta,omitempty"`
	FtsMissRowsInmemory           *uint32                       `protobuf:"varint,146,opt,name=fts_miss_rows_inmemory,json=ftsMissRowsInmemory" json:"fts_miss_rows_inmemory,omitempty"`
	FtsMissReadTimeMs             *uint64                       `protobuf:"varint,147,opt,name=fts_miss_read_time_ms,json=ftsMissReadTimeMs" json:"fts_miss_read_time_ms,omitempty"`
	FtsMissSearchTimeMs           *uint64                       `protobuf:"varint,148,opt,name=fts_miss_search_time_ms,json=ftsMissSearchTimeMs" json:"fts_miss_search_time_ms,omitempty"`
	FtsHitRowsStable              *uint64                       `protobuf:"varint,150,opt,name=fts_hit_rows_stable,json=ftsHitRowsStable" json:"fts_hit_rows_stable,omitempty"`
	FtsHitRowsDelta               *uint64                       `protobuf:"varint,151,opt,name=fts_hit_rows_delta,json=ftsHitRowsDelta" json:"fts_hit_rows_delta,omitempty"`
	FtsHitRowsInmemory            *uint64                       `protobuf:"varint,152,opt,name=fts_hit_rows_inmemory,json=ftsHitRowsInmemory" json:"fts_hit_rows_inmemory,omitempty"`
	FtsHitSearchTimeMs            *uint64                       `protobuf:"varint,153,opt,name=fts_hit_search_time_ms,json=ftsHitSearchTimeMs" json:"fts_hit_search_time_ms,omitempty"`
	FtsHitReadFtsRows             *uint64                       `protobuf:"varint,154,opt,name=fts_hit_read_fts_rows,json=ftsHitReadFtsRows" json:"fts_hit_read_fts_rows,omitempty"`
	FtsHitReadFtsTimeMs           *uint64                       `protobuf:"varint,155,opt,name=fts_hit_read_fts_time_ms,json=ftsHitReadFtsTimeMs" json:"fts_hit_read_fts_time_ms,omitempty"`
	FtsHitReadOthersTimeMs        *uint64                       `protobuf:"varint,156,opt,name=fts_hit_read_others_time_ms,json=ftsHitReadOthersTimeMs" json:"fts_hit_read_others_time_ms,omitempty"`
}
...
func (m *TiFlashScanContext) GetFtsLoadFromS3() uint32 {
	if m != nil && m.FtsLoadFromS3 != nil {
		return *m.FtsLoadFromS3
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsLoadFromDisk() uint32 {
	if m != nil && m.FtsLoadFromDisk != nil {
		return *m.FtsLoadFromDisk
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsLoadFromCache() uint32 {
	if m != nil && m.FtsLoadFromCache != nil {
		return *m.FtsLoadFromCache
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsLoadTimeMs() uint64 {
	if m != nil && m.FtsLoadTimeMs != nil {
		return *m.FtsLoadTimeMs
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsMissRowsStable() uint32 {
	if m != nil && m.FtsMissRowsStable != nil {
		return *m.FtsMissRowsStable
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsMissRowsDelta() uint32 {
	if m != nil && m.FtsMissRowsDelta != nil {
		return *m.FtsMissRowsDelta
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsMissRowsInmemory() uint32 {
	if m != nil && m.FtsMissRowsInmemory != nil {
		return *m.FtsMissRowsInmemory
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsMissReadTimeMs() uint64 {
	if m != nil && m.FtsMissReadTimeMs != nil {
		return *m.FtsMissReadTimeMs
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsMissSearchTimeMs() uint64 {
	if m != nil && m.FtsMissSearchTimeMs != nil {
		return *m.FtsMissSearchTimeMs
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsHitRowsStable() uint64 {
	if m != nil && m.FtsHitRowsStable != nil {
		return *m.FtsHitRowsStable
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsHitRowsDelta() uint64 {
	if m != nil && m.FtsHitRowsDelta != nil {
		return *m.FtsHitRowsDelta
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsHitRowsInmemory() uint64 {
	if m != nil && m.FtsHitRowsInmemory != nil {
		return *m.FtsHitRowsInmemory
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsHitSearchTimeMs() uint64 {
	if m != nil && m.FtsHitSearchTimeMs != nil {
		return *m.FtsHitSearchTimeMs
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsHitReadFtsRows() uint64 {
	if m != nil && m.FtsHitReadFtsRows != nil {
		return *m.FtsHitReadFtsRows
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsHitReadFtsTimeMs() uint64 {
	if m != nil && m.FtsHitReadFtsTimeMs != nil {
		return *m.FtsHitReadFtsTimeMs
	}
	return 0
}

func (m *TiFlashScanContext) GetFtsHitReadOthersTimeMs() uint64 {
	if m != nil && m.FtsHitReadOthersTimeMs != nil {
		return *m.FtsHitReadOthersTimeMs
	}
	return 0
}
...
var fileDescriptor_12d1cdcda51e000f = []byte{
	...
	,
}
...
func (m *TiFlashScanContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FtsHitReadOthersTimeMs != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsHitReadOthersTimeMs))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xe0
	}
	if m.FtsHitReadFtsTimeMs != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsHitReadFtsTimeMs))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xd8
	}
	if m.FtsHitReadFtsRows != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsHitReadFtsRows))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xd0
	}
	if m.FtsHitSearchTimeMs != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsHitSearchTimeMs))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xc8
	}
	if m.FtsHitRowsInmemory != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsHitRowsInmemory))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xc0
	}
	if m.FtsHitRowsDelta != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsHitRowsDelta))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xb8
	}
	if m.FtsHitRowsStable != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsHitRowsStable))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xb0
	}
	if m.FtsMissSearchTimeMs != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsMissSearchTimeMs))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0xa0
	}
	if m.FtsMissReadTimeMs != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsMissReadTimeMs))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0x98
	}
	if m.FtsMissRowsInmemory != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsMissRowsInmemory))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0x90
	}
	if m.FtsMissRowsDelta != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsMissRowsDelta))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0x88
	}
	if m.FtsMissRowsStable != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsMissRowsStable))
		i--
		dAtA[i] = 0x9
		i--
		dAtA[i] = 0x80
	}
	if m.FtsLoadTimeMs != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsLoadTimeMs))
		i--
		dAtA[i] = 0x8
		i--
		dAtA[i] = 0xf8
	}
	if m.FtsLoadFromCache != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsLoadFromCache))
		i--
		dAtA[i] = 0x8
		i--
		dAtA[i] = 0xf0
	}
	if m.FtsLoadFromDisk != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsLoadFromDisk))
		i--
		dAtA[i] = 0x8
		i--
		dAtA[i] = 0xe8
	}
	if m.FtsLoadFromS3 != nil {
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FtsLoadFromS3))
		i--
		dAtA[i] = 0x8
		i--
		dAtA[i] = 0xe0
...
func (m *TiFlashScanContext) Size() (n int) {
	...
	if m.FtsLoadFromS3 != nil {
		n += 2 + sovExecutor(uint64(*m.FtsLoadFromS3))
	}
	if m.FtsLoadFromDisk != nil {
		n += 2 + sovExecutor(uint64(*m.FtsLoadFromDisk))
	}
	if m.FtsLoadFromCache != nil {
		n += 2 + sovExecutor(uint64(*m.FtsLoadFromCache))
	}
	if m.FtsLoadTimeMs != nil {
		n += 2 + sovExecutor(uint64(*m.FtsLoadTimeMs))
	}
	if m.FtsMissRowsStable != nil {
		n += 2 + sovExecutor(uint64(*m.FtsMissRowsStable))
	}
	if m.FtsMissRowsDelta != nil {
		n += 2 + sovExecutor(uint64(*m.FtsMissRowsDelta))
	}
	if m.FtsMissRowsInmemory != nil {
		n += 2 + sovExecutor(uint64(*m.FtsMissRowsInmemory))
	}
	if m.FtsMissReadTimeMs != nil {
		n += 2 + sovExecutor(uint64(*m.FtsMissReadTimeMs))
	}
	if m.FtsMissSearchTimeMs != nil {
		n += 2 + sovExecutor(uint64(*m.FtsMissSearchTimeMs))
	}
	if m.FtsHitRowsStable != nil {
		n += 2 + sovExecutor(uint64(*m.FtsHitRowsStable))
	}
	if m.FtsHitRowsDelta != nil {
		n += 2 + sovExecutor(uint64(*m.FtsHitRowsDelta))
	}
	if m.FtsHitRowsInmemory != nil {
		n += 2 + sovExecutor(uint64(*m.FtsHitRowsInmemory))
	}
	if m.FtsHitSearchTimeMs != nil {
		n += 2 + sovExecutor(uint64(*m.FtsHitSearchTimeMs))
	}
	if m.FtsHitReadFtsRows != nil {
		n += 2 + sovExecutor(uint64(*m.FtsHitReadFtsRows))
	}
	if m.FtsHitReadFtsTimeMs != nil {
		n += 2 + sovExecutor(uint64(*m.FtsHitReadFtsTimeMs))
	}
	if m.FtsHitReadOthersTimeMs != nil {
		n += 2 + sovExecutor(uint64(*m.FtsHitReadOthersTimeMs))
	}
	return n
}
...
func (m *TiFlashScanContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 140:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsLoadFromS3", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 141:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsLoadFromDisk", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 142:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsLoadFromCache", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsLoadFromCache = &v
		case 143:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsLoadTimeMs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 144:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsMissRowsStable", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsMissRowsStable = &v
		case 145:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsMissRowsDelta", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsMissRowsDelta = &v
		case 146:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsMissRowsInmemory", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsMissRowsInmemory = &v
		case 147:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsMissReadTimeMs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsMissReadTimeMs = &v
		case 148:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsMissSearchTimeMs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsMissSearchTimeMs = &v
		case 150:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsHitRowsStable", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsHitRowsStable = &v
		case 151:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsHitRowsDelta", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 152:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsHitRowsInmemory", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsHitRowsInmemory = &v
		case 153:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsHitSearchTimeMs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsHitSearchTimeMs = &v
		case 154:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsHitReadFtsRows", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsHitReadFtsRows = &v
		case 155:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsHitReadFtsTimeMs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FtsHitReadFtsTimeMs = &v
		case 156:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FtsHitReadOthersTimeMs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
