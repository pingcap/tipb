...
type ExchangeSender struct {
	...
	PartitionKeyTypes []*FieldType `protobuf:"bytes,5,rep,name=partition_key_types,json=partitionKeyTypes" json:"partition_key_types,omitempty"`
...
func (m *ExchangeSender) GetPartitionKeyTypes() []*FieldType {
	if m != nil {
		return m.PartitionKeyTypes
	}
	return nil
}
...
func (m *ExchangeSender) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PartitionKeyTypes) > 0 {
		for _, msg := range m.PartitionKeyTypes {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *ExchangeSender) Size() (n int) {
	...
	if len(m.PartitionKeyTypes) > 0 {
		for _, e := range m.PartitionKeyTypes {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *ExchangeSender) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PartitionKeyTypes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PartitionKeyTypes = append(m.PartitionKeyTypes, &FieldType{})
			if err := m.PartitionKeyTypes[len(m.PartitionKeyTypes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
