...
type ExchangeReceiver struct {
	...
	DownstreamCteTaskMeta []*EncodedBytesSlice `protobuf:"bytes,4,rep,name=downstream_cte_task_meta,json=downstreamCteTaskMeta" json:"downstream_cte_task_meta,omitempty"`
	XXX_unrecognized      []byte               `json:"-"`
}
...
func (m *ExchangeReceiver) GetDownstreamCteTaskMeta() []*EncodedBytesSlice {
	if m != nil {
		return m.DownstreamCteTaskMeta
	}
	return nil
}
...
type CteProducer struct {
	SeedExec         *Executor `protobuf:"bytes,1,opt,name=SeedExec" json:"SeedExec,omitempty"`
	RecurExec        *Executor `protobuf:"bytes,2,opt,name=RecurExec" json:"RecurExec,omitempty"`
	CteID            *int64    `protobuf:"varint,3,opt,name=CteID" json:"CteID,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}

func (m *CteProducer) Reset()                    { *m = CteProducer{} }
func (m *CteProducer) String() string            { return proto.CompactTextString(m) }
func (*CteProducer) ProtoMessage()               {}
func (*CteProducer) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{23} }

func (m *CteProducer) GetSeedExec() *Executor {
	if m != nil {
		return m.SeedExec
	}
	return nil
...
func (m *CteProducer) GetRecurExec() *Executor {
	if m != nil {
		return m.RecurExec
	}
	return nil
...
func (m *CteProducer) GetCteID() int64 {
	if m != nil && m.CteID != nil {
		return *m.CteID
	}
	return 0
}
...
type CteConsumer struct {
	CteID            *int64 `protobuf:"varint,1,opt,name=CteID" json:"CteID,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *CteConsumer) Reset()                    { *m = CteConsumer{} }
func (m *CteConsumer) String() string            { return proto.CompactTextString(m) }
func (*CteConsumer) ProtoMessage()               {}
func (*CteConsumer) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{24} }

func (m *CteConsumer) GetCteID() int64 {
	if m != nil && m.CteID != nil {
		return *m.CteID
	}
	return 0
...
type Sequence struct {
	Children         []*Executor `protobuf:"bytes,1,rep,name=children" json:"children,omitempty"`
	XXX_unrecognized []byte      `json:"-"`
}
...
func (*Sequence) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{25} }

func (m *Sequence) GetChildren() []*Executor {
	if m != nil {
		return m.Children
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CteProducer)(nil), "tipb.CteProducer")
	proto.RegisterType((*CteConsumer)(nil), "tipb.CteConsumer")
	proto.RegisterType((*Sequence)(nil), "tipb.Sequence")
...
func (m *ExchangeReceiver) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DownstreamCteTaskMeta) > 0 {
		for _, msg := range m.DownstreamCteTaskMeta {
			dAtA[i] = 0x22
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *CteProducer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CteProducer) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.SeedExec != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.SeedExec.Size()))
		n30, err := m.SeedExec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.RecurExec != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.RecurExec.Size()))
		n31, err := m.RecurExec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *CteConsumer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CteConsumer) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ExchangeReceiver) Size() (n int) {
	...
	if len(m.DownstreamCteTaskMeta) > 0 {
		for _, e := range m.DownstreamCteTaskMeta {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *ExchangeReceiver) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DownstreamCteTaskMeta", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DownstreamCteTaskMeta = append(m.DownstreamCteTaskMeta, &EncodedBytesSlice{})
			if err := m.DownstreamCteTaskMeta[len(m.DownstreamCteTaskMeta)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CteProducer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CteProducer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CteProducer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SeedExec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.SeedExec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RecurExec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RecurExec == nil {
				m.RecurExec = &Executor{}
			}
			if err := m.RecurExec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *CteConsumer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CteConsumer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CteConsumer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
