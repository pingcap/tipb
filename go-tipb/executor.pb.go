...
type TableScanANNHint struct {
	TopNOrderBy      *ByItem `protobuf:"bytes,1,opt,name=top_n_order_by,json=topNOrderBy" json:"top_n_order_by,omitempty"`
	TopNLimit        int64   `protobuf:"varint,2,opt,name=top_n_limit,json=topNLimit" json:"top_n_limit"`
	PreFilters       *Expr   `protobuf:"bytes,3,opt,name=pre_filters,json=preFilters" json:"pre_filters,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}

func (m *TableScanANNHint) Reset()                    { *m = TableScanANNHint{} }
func (m *TableScanANNHint) String() string            { return proto.CompactTextString(m) }
func (*TableScanANNHint) ProtoMessage()               {}
func (*TableScanANNHint) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{4} }

func (m *TableScanANNHint) GetTopNOrderBy() *ByItem {
	if m != nil {
		return m.TopNOrderBy
	}
	return nil
}

func (m *TableScanANNHint) GetTopNLimit() int64 {
	if m != nil {
		return m.TopNLimit
	}
	return 0
...
func (m *TableScanANNHint) GetPreFilters() *Expr {
	if m != nil {
		return m.PreFilters
	}
	return nil
...
type TableScan struct {
	...
	AnnHint                    *TableScanANNHint `protobuf:"bytes,13,opt,name=ann_hint,json=annHint" json:"ann_hint,omitempty"`
...
func (m *TableScan) GetAnnHint() *TableScanANNHint {
	if m != nil {
		return m.AnnHint
	}
	return nil
...
type PartitionTableScan struct {
	...
	AnnHint                    *TableScanANNHint `protobuf:"bytes,11,opt,name=ann_hint,json=annHint" json:"ann_hint,omitempty"`
...
func (m *PartitionTableScan) GetAnnHint() *TableScanANNHint {
	if m != nil {
		return m.AnnHint
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TableScanANNHint)(nil), "tipb.TableScanANNHint")
...
func (m *TableScanANNHint) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TableScanANNHint) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.TopNOrderBy != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.TopNOrderBy.Size()))
		n18, err := m.TopNOrderBy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	dAtA[i] = 0x10
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(m.TopNLimit))
	if m.PreFilters != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.PreFilters.Size()))
		n19, err := m.PreFilters.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *TableScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AnnHint != nil {
		dAtA[i] = 0x6a
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.AnnHint.Size()))
		n20, err := m.AnnHint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *PartitionTableScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AnnHint != nil {
		...
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.AnnHint.Size()))
		n21, err := m.AnnHint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *TableScanANNHint) Size() (n int) {
	var l int
	_ = l
	if m.TopNOrderBy != nil {
		l = m.TopNOrderBy.Size()
		n += 1 + l + sovExecutor(uint64(l))
	}
	n += 1 + sovExecutor(uint64(m.TopNLimit))
	if m.PreFilters != nil {
		l = m.PreFilters.Size()
		n += 1 + l + sovExecutor(uint64(l))
	}
...
func (m *TableScanANNHint) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TableScanANNHint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TableScanANNHint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopNOrderBy", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TopNOrderBy == nil {
				m.TopNOrderBy = &ByItem{}
			}
			if err := m.TopNOrderBy.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopNLimit", wireType)
			}
			m.TopNLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TopNLimit |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			if err := m.PreFilters.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TableScan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AnnHint", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AnnHint == nil {
				m.AnnHint = &TableScanANNHint{}
			}
			if err := m.AnnHint.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
