...
type TiFlashScanContext struct {
	...
	TotalDmfileRoughSetIndexCheckTimeNs *uint64 `protobuf:"varint,14,opt,name=total_dmfile_rough_set_index_check_time_ns,json=totalDmfileRoughSetIndexCheckTimeNs" json:"total_dmfile_rough_set_index_check_time_ns,omitempty"`
	XXX_unrecognized                    []byte  `json:"-"`
}
...
func (m *TiFlashScanContext) GetTotalDmfileRoughSetIndexCheckTimeNs() uint64 {
	if m != nil && m.TotalDmfileRoughSetIndexCheckTimeNs != nil {
		return *m.TotalDmfileRoughSetIndexCheckTimeNs
	}
	return 0
}
...
func (m *TiFlashScanContext) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TotalDmfileRoughSetIndexCheckTimeNs != nil {
		dAtA[i] = 0x70
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalDmfileRoughSetIndexCheckTimeNs))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *TiFlashScanContext) Size() (n int) {
	...
	if m.TotalDmfileRoughSetIndexCheckTimeNs != nil {
		n += 1 + sovExecutor(uint64(*m.TotalDmfileRoughSetIndexCheckTimeNs))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *TiFlashScanContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDmfileRoughSetIndexCheckTimeNs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalDmfileRoughSetIndexCheckTimeNs = &v
		default:
			iNdEx = preIndex
			skippy, err := skipExecutor(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
