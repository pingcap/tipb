...
type ANNQueryInfo struct {
	...
	// used and TableScan must output an additional column using the Distance function. Implementor
	// does not need to really generate the Vector data column.
	EnableDistanceProj bool `protobuf:"varint,20,opt,name=enable_distance_proj,json=enableDistanceProj" json:"enable_distance_proj"`
	// Which Column ID in the columns[] should be the distance column.
	// Usually its value is -2000.
	VirtualDistanceColId int32  `protobuf:"varint,21,opt,name=virtual_distance_col_id,json=virtualDistanceColId" json:"virtual_distance_col_id"`
	XXX_unrecognized     []byte `json:"-"`
}
...
func (m *ANNQueryInfo) GetVirtualDistanceColId() int32 {
	if m != nil {
		return m.VirtualDistanceColId
	}
	return 0
}
...
func (m *ANNQueryInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(m.VirtualDistanceColId))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *ANNQueryInfo) Size() (n int) {
	...
	n += 3
	n += 2 + sovExecutor(uint64(m.VirtualDistanceColId))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
...
func (m *ANNQueryInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VirtualDistanceColId", wireType)
			}
			m.VirtualDistanceColId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExecutor
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VirtualDistanceColId |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorExecutor = []byte{
	...
	,
}
