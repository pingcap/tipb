...
func (WindowBoundType) EnumDescriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{11} }
...
func (RangeCmpDataType) EnumDescriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{12} }
...
func (WindowFrameType) EnumDescriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{13} }

type TiFlashIndexType int32

const (
	TiFlashIndexType_InvalidIndex TiFlashIndexType = 0
	TiFlashIndexType_Vector       TiFlashIndexType = 1
	TiFlashIndexType_Set          TiFlashIndexType = 2
	TiFlashIndexType_BloomFilter  TiFlashIndexType = 3
)

var TiFlashIndexType_name = map[int32]string{
	0: "InvalidIndex",
	1: "Vector",
	2: "Set",
	3: "BloomFilter",
}
var TiFlashIndexType_value = map[string]int32{
	"InvalidIndex": 0,
	"Vector":       1,
	"Set":          2,
	"BloomFilter":  3,
...
func (x TiFlashIndexType) Enum() *TiFlashIndexType {
	p := new(TiFlashIndexType)
	*p = x
	return p
}
func (x TiFlashIndexType) String() string {
	return proto.EnumName(TiFlashIndexType_name, int32(x))
}
func (x *TiFlashIndexType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(TiFlashIndexType_value, data, "TiFlashIndexType")
	if err != nil {
		return err
	}
	*x = TiFlashIndexType(value)
	return nil
}
func (TiFlashIndexType) EnumDescriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{14} }
...
type TiFlashVectorIndexInfo struct {
	IndexKind        *VectorIndexKind      `protobuf:"varint,1,req,name=index_kind,json=indexKind,enum=tipb.VectorIndexKind" json:"index_kind,omitempty"`
	DistanceMetric   *VectorDistanceMetric `protobuf:"varint,2,req,name=distance_metric,json=distanceMetric,enum=tipb.VectorDistanceMetric" json:"distance_metric,omitempty"`
	Dimension        *uint64               `protobuf:"varint,3,req,name=dimension" json:"dimension,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}

func (m *TiFlashVectorIndexInfo) Reset()                    { *m = TiFlashVectorIndexInfo{} }
func (m *TiFlashVectorIndexInfo) String() string            { return proto.CompactTextString(m) }
func (*TiFlashVectorIndexInfo) ProtoMessage()               {}
func (*TiFlashVectorIndexInfo) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{29} }

func (m *TiFlashVectorIndexInfo) GetIndexKind() VectorIndexKind {
	if m != nil && m.IndexKind != nil {
		return *m.IndexKind
	}
	return VectorIndexKind_INVALID_INDEX_KIND
}

func (m *TiFlashVectorIndexInfo) GetDistanceMetric() VectorDistanceMetric {
	if m != nil && m.DistanceMetric != nil {
		return *m.DistanceMetric
	}
	return VectorDistanceMetric_INVALID_DISTANCE_METRIC
}

func (m *TiFlashVectorIndexInfo) GetDimension() uint64 {
...
type AddTiFlashIndexTask struct {
	IndexType        *TiFlashIndexType       `protobuf:"varint,1,req,name=index_type,json=indexType,enum=tipb.TiFlashIndexType" json:"index_type,omitempty"`
	TableId          *int64                  `protobuf:"varint,2,req,name=table_id,json=tableId" json:"table_id,omitempty"`
	ColumnId         *int64                  `protobuf:"varint,3,req,name=column_id,json=columnId" json:"column_id,omitempty"`
	VectorIndexInfo  *TiFlashVectorIndexInfo `protobuf:"bytes,4,opt,name=vector_index_info,json=vectorIndexInfo" json:"vector_index_info,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}

func (m *AddTiFlashIndexTask) Reset()                    { *m = AddTiFlashIndexTask{} }
func (m *AddTiFlashIndexTask) String() string            { return proto.CompactTextString(m) }
func (*AddTiFlashIndexTask) ProtoMessage()               {}
func (*AddTiFlashIndexTask) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{30} }

func (m *AddTiFlashIndexTask) GetIndexType() TiFlashIndexType {
	if m != nil && m.IndexType != nil {
		return *m.IndexType
	}
	return TiFlashIndexType_InvalidIndex
}

func (m *AddTiFlashIndexTask) GetTableId() int64 {
...
func (m *AddTiFlashIndexTask) GetColumnId() int64 {
...
func (m *AddTiFlashIndexTask) GetVectorIndexInfo() *TiFlashVectorIndexInfo {
	if m != nil {
		return m.VectorIndexInfo
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*TiFlashVectorIndexInfo)(nil), "tipb.TiFlashVectorIndexInfo")
	proto.RegisterType((*AddTiFlashIndexTask)(nil), "tipb.AddTiFlashIndexTask")
	...
	proto.RegisterEnum("tipb.TiFlashIndexType", TiFlashIndexType_name, TiFlashIndexType_value)
}
...
func (m *TiFlashVectorIndexInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TiFlashVectorIndexInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.IndexKind == nil {
		...
		dAtA[i] = 0x8
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.IndexKind))
	}
	if m.DistanceMetric == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
		dAtA[i] = 0x10
		i++
...
func (m *AddTiFlashIndexTask) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AddTiFlashIndexTask) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.VectorIndexInfo != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.VectorIndexInfo.Size()))
		n35, err := m.VectorIndexInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *TiFlashVectorIndexInfo) Size() (n int) {
	var l int
	_ = l
	if m.IndexKind != nil {
		n += 1 + sovExecutor(uint64(*m.IndexKind))
	}
	if m.DistanceMetric != nil {
		n += 1 + sovExecutor(uint64(*m.DistanceMetric))
	}
...
func (m *AddTiFlashIndexTask) Size() (n int) {
	var l int
	_ = l
	if m.IndexType != nil {
...
func (m *TiFlashVectorIndexInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TiFlashVectorIndexInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TiFlashVectorIndexInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexKind", wireType)
			}
			var v VectorIndexKind
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExecutor
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (VectorIndexKind(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (VectorDistanceMetric(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AddTiFlashIndexTask) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddTiFlashIndexTask: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddTiFlashIndexTask: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (TiFlashIndexType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VectorIndexInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.VectorIndexInfo == nil {
				m.VectorIndexInfo = &TiFlashVectorIndexInfo{}
			}
			if err := m.VectorIndexInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
