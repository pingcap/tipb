...
type Aggregation struct {
	...
	RpnRootOperator *Expr      `protobuf:"bytes,7,opt,name=rpn_root_operator,json=rpnRootOperator" json:"rpn_root_operator,omitempty"`
...
func (m *Aggregation) GetRpnRootOperator() *Expr {
	if m != nil {
		return m.RpnRootOperator
	}
	return nil
}
...
func (m *Aggregation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RpnRootOperator != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.RpnRootOperator.Size()))
		n12, err := m.RpnRootOperator.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *Aggregation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RpnRootOperator", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RpnRootOperator == nil {
				m.RpnRootOperator = &Expr{}
			}
			if err := m.RpnRootOperator.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
