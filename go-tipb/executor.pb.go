...
type ANNQueryInfo struct {
	QueryType        *ANNQueryType           `protobuf:"varint,1,opt,name=query_type,json=queryType,enum=tipb.ANNQueryType" json:"query_type,omitempty"`
	DistanceMetric   *ANNQueryDistanceMetric `protobuf:"varint,2,opt,name=distance_metric,json=distanceMetric,enum=tipb.ANNQueryDistanceMetric" json:"distance_metric,omitempty"`
	TopK             *uint64                 `protobuf:"varint,3,opt,name=top_k,json=topK" json:"top_k,omitempty"`
	RefVecF32        []float32               `protobuf:"fixed32,4,rep,name=ref_vec_f32,json=refVecF32" json:"ref_vec_f32,omitempty"`
	MaxDistance      *float64                `protobuf:"fixed64,10,opt,name=max_distance,json=maxDistance" json:"max_distance,omitempty"`
	HnswEfSearch     *uint32                 `protobuf:"varint,20,opt,name=hnsw_ef_search,json=hnswEfSearch" json:"hnsw_ef_search,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
...
func (m *ANNQueryInfo) GetTopK() uint64 {
	if m != nil && m.TopK != nil {
		return *m.TopK
	}
	return 0
...
func (m *ANNQueryInfo) GetRefVecF32() []float32 {
	if m != nil {
		return m.RefVecF32
	}
	return nil
...
func (m *ANNQueryInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RefVecF32) > 0 {
		for _, num := range m.RefVecF32 {
			dAtA[i] = 0x25
			i++
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (ANNQueryDistanceMetric(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			if wireType == 5 {
				...
				m.RefVecF32 = append(m.RefVecF32, v2)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
