...
type IndexScan struct {
	...
	// TableShardInfos carries shard mapping for TiCI index scan. It is populated by the planner/dispatcher
	// and consumed by TiFlash/TiCI runtime to locate shards by executor id.
	TableShardInfos []*TableShardInfos `protobuf:"bytes,8,rep,name=table_shard_infos,json=tableShardInfos" json:"table_shard_infos,omitempty"`
}
...
func (m *IndexScan) GetTableShardInfos() []*TableShardInfos {
	if m != nil {
...
// ShardInfo represents a single shard's id, epoch and key ranges.
type ShardInfo struct {
	ShardId    uint64      `protobuf:"varint,1,opt,name=shard_id,json=shardId" json:"shard_id"`
	ShardEpoch []byte      `protobuf:"bytes,2,opt,name=shard_epoch,json=shardEpoch" json:"shard_epoch,omitempty"`
...
func (m *ShardInfo) GetShardEpoch() []byte {
	if m != nil {
		return m.ShardEpoch
	}
	return nil
...
// TableShardInfos groups shard infos for a particular executor id.
type TableShardInfos struct {
	ExecutorId *string      `protobuf:"bytes,1,opt,name=executor_id,json=executorId" json:"executor_id,omitempty"`
	ShardInfos []*ShardInfo `protobuf:"bytes,2,rep,name=shard_infos,json=shardInfos" json:"shard_infos,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*ShardInfo)(nil), "tipb.ShardInfo")
	proto.RegisterType((*TableShardInfos)(nil), "tipb.TableShardInfos")
...
var fileDescriptor_12d1cdcda51e000f = []byte{
	// 5895 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *ShardInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ShardEpoch != nil {
		i -= len(m.ShardEpoch)
		copy(dAtA[i:], m.ShardEpoch)
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.ShardEpoch)))
		i--
		dAtA[i] = 0x12
	}
	i = encodeVarintExecutor(dAtA, i, uint64(m.ShardId))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *ShardInfo) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovExecutor(uint64(m.ShardId))
	if m.ShardEpoch != nil {
		l = len(m.ShardEpoch)
		n += 1 + l + sovExecutor(uint64(l))
	}
...
func (m *ShardInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.ShardEpoch = append(m.ShardEpoch[:0], dAtA[iNdEx:postIndex]...)
			if m.ShardEpoch == nil {
				m.ShardEpoch = []byte{}
			}
			iNdEx = postIndex
