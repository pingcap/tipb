...
type ExecutorExecutionSummary struct {
	...
	//	*ExecutorExecutionSummary_TableScanContext
...
type ExecutorExecutionSummary_TableScanContext struct {
	TableScanContext *TableScanContext `protobuf:"bytes,6,opt,name=table_scan_context,json=tableScanContext,oneof"`
}

func (*ExecutorExecutionSummary_TableScanContext) isExecutorExecutionSummary_DetailInfo() {}
...
func (m *ExecutorExecutionSummary) GetTableScanContext() *TableScanContext {
	if x, ok := m.GetDetailInfo().(*ExecutorExecutionSummary_TableScanContext); ok {
		return x.TableScanContext
	}
	return nil
}
...
func (*ExecutorExecutionSummary) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ExecutorExecutionSummary_OneofMarshaler, _ExecutorExecutionSummary_OneofUnmarshaler, _ExecutorExecutionSummary_OneofSizer, []interface{}{
		(*ExecutorExecutionSummary_TableScanContext)(nil),
	}
}
...
func _ExecutorExecutionSummary_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ExecutorExecutionSummary_TableScanContext:
		_ = b.EncodeVarint(6<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.TableScanContext); err != nil {
			return err
		}
	case nil:
	default:
...
func _ExecutorExecutionSummary_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ExecutorExecutionSummary)
	switch tag {
	case 6: // DetailInfo.table_scan_context
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TableScanContext)
		err := b.DecodeMessage(msg)
		m.DetailInfo = &ExecutorExecutionSummary_TableScanContext{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ExecutorExecutionSummary_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.DetailInfo.(type) {
	case *ExecutorExecutionSummary_TableScanContext:
		s := proto.Size(x.TableScanContext)
...
type TableScanContext struct {
	ScanPacksCount                      *uint64 `protobuf:"varint,1,opt,name=scan_packs_count,json=scanPacksCount" json:"scan_packs_count,omitempty"`
	ScanRowsCount                       *uint64 `protobuf:"varint,2,opt,name=scan_rows_count,json=scanRowsCount" json:"scan_rows_count,omitempty"`
	SkipPacksCount                      *uint64 `protobuf:"varint,3,opt,name=skip_packs_count,json=skipPacksCount" json:"skip_packs_count,omitempty"`
	SkipRowsCount                       *uint64 `protobuf:"varint,4,opt,name=skip_rows_count,json=skipRowsCount" json:"skip_rows_count,omitempty"`
	RoughSetIndexLoadTimeInMilliseconds *uint64 `protobuf:"varint,5,opt,name=rough_set_index_load_time_in_milliseconds,json=roughSetIndexLoadTimeInMilliseconds" json:"rough_set_index_load_time_in_milliseconds,omitempty"`
	DmfileReadTimeInMilliseconds        *uint64 `protobuf:"varint,6,opt,name=dmfile_read_time_in_milliseconds,json=dmfileReadTimeInMilliseconds" json:"dmfile_read_time_in_milliseconds,omitempty"`
	CreateSnapshotTimeInMilliseconds    *uint64 `protobuf:"varint,7,opt,name=create_snapshot_time_in_milliseconds,json=createSnapshotTimeInMilliseconds" json:"create_snapshot_time_in_milliseconds,omitempty"`
	XXX_unrecognized                    []byte  `json:"-"`
}

func (m *TableScanContext) Reset()                    { *m = TableScanContext{} }
func (m *TableScanContext) String() string            { return proto.CompactTextString(m) }
func (*TableScanContext) ProtoMessage()               {}
func (*TableScanContext) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{14} }

func (m *TableScanContext) GetScanPacksCount() uint64 {
	if m != nil && m.ScanPacksCount != nil {
		return *m.ScanPacksCount
	}
	return 0
}

func (m *TableScanContext) GetScanRowsCount() uint64 {
	if m != nil && m.ScanRowsCount != nil {
		return *m.ScanRowsCount
	}
	return 0
}

func (m *TableScanContext) GetSkipPacksCount() uint64 {
	if m != nil && m.SkipPacksCount != nil {
		return *m.SkipPacksCount
	}
	return 0
}

func (m *TableScanContext) GetSkipRowsCount() uint64 {
	if m != nil && m.SkipRowsCount != nil {
		return *m.SkipRowsCount
	}
	return 0
}

func (m *TableScanContext) GetRoughSetIndexLoadTimeInMilliseconds() uint64 {
	if m != nil && m.RoughSetIndexLoadTimeInMilliseconds != nil {
		return *m.RoughSetIndexLoadTimeInMilliseconds
	}
	return 0
}

func (m *TableScanContext) GetDmfileReadTimeInMilliseconds() uint64 {
	if m != nil && m.DmfileReadTimeInMilliseconds != nil {
		return *m.DmfileReadTimeInMilliseconds
	}
	return 0
}

func (m *TableScanContext) GetCreateSnapshotTimeInMilliseconds() uint64 {
	if m != nil && m.CreateSnapshotTimeInMilliseconds != nil {
		return *m.CreateSnapshotTimeInMilliseconds
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*TableScanContext)(nil), "tipb.TableScanContext")
...
func (m *ExecutorExecutionSummary_TableScanContext) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.TableScanContext != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.TableScanContext.Size()))
		n22, err := m.TableScanContext.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *TableScanContext) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TableScanContext) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.ScanPacksCount != nil {
		dAtA[i] = 0x8
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.ScanPacksCount))
	}
	if m.ScanRowsCount != nil {
		dAtA[i] = 0x10
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.ScanRowsCount))
	}
	if m.SkipPacksCount != nil {
		dAtA[i] = 0x18
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.SkipPacksCount))
	}
	if m.SkipRowsCount != nil {
		dAtA[i] = 0x20
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.SkipRowsCount))
	}
	if m.RoughSetIndexLoadTimeInMilliseconds != nil {
		dAtA[i] = 0x28
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.RoughSetIndexLoadTimeInMilliseconds))
	}
	if m.DmfileReadTimeInMilliseconds != nil {
		dAtA[i] = 0x30
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.DmfileReadTimeInMilliseconds))
	}
	if m.CreateSnapshotTimeInMilliseconds != nil {
		dAtA[i] = 0x38
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.CreateSnapshotTimeInMilliseconds))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ExecutorExecutionSummary_TableScanContext) Size() (n int) {
	var l int
	_ = l
	if m.TableScanContext != nil {
		l = m.TableScanContext.Size()
		n += 1 + l + sovExecutor(uint64(l))
	}
	return n
}
func (m *TableScanContext) Size() (n int) {
	var l int
	_ = l
	if m.ScanPacksCount != nil {
		n += 1 + sovExecutor(uint64(*m.ScanPacksCount))
	}
	if m.ScanRowsCount != nil {
		n += 1 + sovExecutor(uint64(*m.ScanRowsCount))
	}
	if m.SkipPacksCount != nil {
		n += 1 + sovExecutor(uint64(*m.SkipPacksCount))
	}
	if m.SkipRowsCount != nil {
		n += 1 + sovExecutor(uint64(*m.SkipRowsCount))
	}
	if m.RoughSetIndexLoadTimeInMilliseconds != nil {
		n += 1 + sovExecutor(uint64(*m.RoughSetIndexLoadTimeInMilliseconds))
	}
	if m.DmfileReadTimeInMilliseconds != nil {
		n += 1 + sovExecutor(uint64(*m.DmfileReadTimeInMilliseconds))
	}
	if m.CreateSnapshotTimeInMilliseconds != nil {
		n += 1 + sovExecutor(uint64(*m.CreateSnapshotTimeInMilliseconds))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ExecutorExecutionSummary) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableScanContext", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DetailInfo = &ExecutorExecutionSummary_TableScanContext{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipExecutor(dAtA[iNdEx:])
...
func (m *TableScanContext) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TableScanContext: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TableScanContext: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScanPacksCount", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScanRowsCount", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipPacksCount", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipRowsCount", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RoughSetIndexLoadTimeInMilliseconds", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RoughSetIndexLoadTimeInMilliseconds = &v
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DmfileReadTimeInMilliseconds", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DmfileReadTimeInMilliseconds = &v
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreateSnapshotTimeInMilliseconds", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CreateSnapshotTimeInMilliseconds = &v
		default:
			iNdEx = preIndex
			skippy, err := skipExecutor(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
