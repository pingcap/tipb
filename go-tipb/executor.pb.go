...
type Aggregation struct {
	...
	FuncType   *ExprType  `protobuf:"varint,7,opt,name=func_type,json=funcType,enum=tipb.ExprType" json:"func_type,omitempty"`
...
func (m *Aggregation) GetFuncType() ExprType {
...
func (m *Aggregation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FuncType != nil {
		dAtA[i] = 0x38
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.FuncType))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Aggregation) Size() (n int) {
	...
	if m.FuncType != nil {
		n += 1 + sovExecutor(uint64(*m.FuncType))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Aggregation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FuncType", wireType)
			}
			var v ExprType
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
