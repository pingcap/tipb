...
type TiFlashScanContext struct {
	...
	InvertedIdxLoadFromS3         *uint64                       `protobuf:"varint,109,opt,name=inverted_idx_load_from_s3,json=invertedIdxLoadFromS3" json:"inverted_idx_load_from_s3,omitempty"`
	InvertedIdxLoadFromDisk       *uint64                       `protobuf:"varint,110,opt,name=inverted_idx_load_from_disk,json=invertedIdxLoadFromDisk" json:"inverted_idx_load_from_disk,omitempty"`
	InvertedIdxLoadFromCache      *uint64                       `protobuf:"varint,111,opt,name=inverted_idx_load_from_cache,json=invertedIdxLoadFromCache" json:"inverted_idx_load_from_cache,omitempty"`
	InvertedIdxLoadTimeMs         *uint64                       `protobuf:"varint,112,opt,name=inverted_idx_load_time_ms,json=invertedIdxLoadTimeMs" json:"inverted_idx_load_time_ms,omitempty"`
	InvertedIdxSearchTimeMs       *uint64                       `protobuf:"varint,113,opt,name=inverted_idx_search_time_ms,json=invertedIdxSearchTimeMs" json:"inverted_idx_search_time_ms,omitempty"`
	InvertedIdxSearchSkippedPacks *uint64                       `protobuf:"varint,114,opt,name=inverted_idx_search_skipped_packs,json=invertedIdxSearchSkippedPacks" json:"inverted_idx_search_skipped_packs,omitempty"`
	InvertedIdxIndexedRows        *uint64                       `protobuf:"varint,115,opt,name=inverted_idx_indexed_rows,json=invertedIdxIndexedRows" json:"inverted_idx_indexed_rows,omitempty"`
	InvertedIdxSearchSelectedRows *uint64                       `protobuf:"varint,116,opt,name=inverted_idx_search_selected_rows,json=invertedIdxSearchSelectedRows" json:"inverted_idx_search_selected_rows,omitempty"`
}
...
func (m *TiFlashScanContext) GetInvertedIdxLoadFromS3() uint64 {
...
func (m *TiFlashScanContext) GetInvertedIdxLoadFromDisk() uint64 {
...
func (m *TiFlashScanContext) GetInvertedIdxLoadFromCache() uint64 {
...
func (m *TiFlashScanContext) GetInvertedIdxSearchSkippedPacks() uint64 {
...
var fileDescriptor_12d1cdcda51e000f = []byte{
	...
	,
}
