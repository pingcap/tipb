...
const (
	...
	ExecType_TypeExchangeReceiver ExecType = 8
...
type Executor struct {
	...
	ExchangeSender   *ExchangeSender   `protobuf:"bytes,11,opt,name=exchange_sender,json=exchangeSender" json:"exchange_sender,omitempty"`
...
func (*ExchangeReceiver) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{1} }
...
func (m *ExchangeReceiver) GetPartitionKeys() []*Expr {
	if m != nil {
...
func (m *ExchangeReceiver) GetChild() *Executor {
	if m != nil {
		return m.Child
	}
	return nil
...
func (m *ExchangeSender) GetFieldTypes() []*FieldType {
	if m != nil {
		return m.FieldTypes
	}
	return nil
...
func (m *Executor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExchangeSender != nil {
		...
		n9, err := m.ExchangeSender.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
var fileDescriptorExecutor = []byte{
	...
	,
}
