...
type MemTableScan struct {
	DbName           string        `protobuf:"bytes,1,opt,name=db_name,json=dbName" json:"db_name"`
...
func (m *MemTableScan) GetDbName() string {
	if m != nil {
		return m.DbName
	}
	return ""
...
func (m *MemTableScan) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(len(m.DbName)))
...
var fileDescriptorExecutor = []byte{
	...
	,
}
