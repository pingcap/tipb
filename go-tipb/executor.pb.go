...
type Aggregation struct {
	...
	RootOperator *Expr      `protobuf:"bytes,7,opt,name=root_operator,json=rootOperator" json:"root_operator,omitempty"`
...
func (m *Aggregation) GetRootOperator() *Expr {
	if m != nil {
		return m.RootOperator
	}
	return nil
}
...
func (m *Aggregation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RootOperator != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.RootOperator.Size()))
		n12, err := m.RootOperator.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *Aggregation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootOperator", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RootOperator.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
