...
type ItemInterval int32

const (
	ItemInterval_ITEM_INTERVAL_UNSPECIFIED ItemInterval = 0
	ItemInterval_ITEM_INTERVAL_15S         ItemInterval = 15
	ItemInterval_ITEM_INTERVAL_30S         ItemInterval = 30
	ItemInterval_ITEM_INTERVAL_60S         ItemInterval = 60
)

var ItemInterval_name = map[int32]string{
	0:  "ITEM_INTERVAL_UNSPECIFIED",
	15: "ITEM_INTERVAL_15S",
	30: "ITEM_INTERVAL_30S",
	60: "ITEM_INTERVAL_60S",
}

var ItemInterval_value = map[string]int32{
	"ITEM_INTERVAL_UNSPECIFIED": 0,
	"ITEM_INTERVAL_15S":         15,
	"ITEM_INTERVAL_30S":         30,
	"ITEM_INTERVAL_60S":         60,
}

func (x ItemInterval) String() string {
	return proto.EnumName(ItemInterval_name, int32(x))
}

func (ItemInterval) EnumDescriptor() ([]byte, []int) {
...
type TopRUConfig struct {
	...
	ItemIntervalSeconds ItemInterval `protobuf:"varint,1,opt,name=item_interval_seconds,json=itemIntervalSeconds,proto3,enum=tipb.ItemInterval" json:"item_interval_seconds,omitempty"`
}
...
func (m *TopRUConfig) GetItemIntervalSeconds() ItemInterval {
	if m != nil {
		return m.ItemIntervalSeconds
	}
	return ItemInterval_ITEM_INTERVAL_UNSPECIFIED
}
...
func init() {
	...
	proto.RegisterEnum("tipb.ItemInterval", ItemInterval_name, ItemInterval_value)
...
var fileDescriptor_1b19f3a2fcd6965e = []byte{
	...
	,
}
...
func (m *TopRUConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ItemIntervalSeconds != 0 {
		i = encodeVarintTopsqlAgent(dAtA, i, uint64(m.ItemIntervalSeconds))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TopRUConfig) Size() (n int) {
	...
	_ = l
	if m.ItemIntervalSeconds != 0 {
		n += 1 + sovTopsqlAgent(uint64(m.ItemIntervalSeconds))
	}
	return n
}
...
func (m *TopRUConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ItemIntervalSeconds", wireType)
			}
			m.ItemIntervalSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTopsqlAgent
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ItemIntervalSeconds |= ItemInterval(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
