...
type SelectResponse struct {
	...
	ChunkedArrays    []*ChunkedArray `protobuf:"bytes,7,rep,name=chunkedArrays" json:"chunkedArrays,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
...
func (m *SelectResponse) GetChunkedArrays() []*ChunkedArray {
	if m != nil {
		return m.ChunkedArrays
	}
	return nil
}
...
func (m *SelectResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ChunkedArrays) > 0 {
		for _, msg := range m.ChunkedArrays {
			dAtA[i] = 0x3a
			i++
			i = encodeVarintSelect(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *SelectResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChunkedArrays", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChunkedArrays = append(m.ChunkedArrays, &ChunkedArray{})
			if err := m.ChunkedArrays[len(m.ChunkedArrays)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorSelect = []byte{
	...
	,
}
