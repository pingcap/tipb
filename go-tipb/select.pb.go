...
type SelectResponse struct {
	...
	OutputCounts []int64  `protobuf:"varint,5,rep,name=output_counts" json:"output_counts,omitempty"`
	WarningCount *int64   `protobuf:"varint,6,opt,name=warning_count" json:"warning_count,omitempty"`
	// The execution summary of each executor, in the order in request.
	ExecutionSummaries []*ExecutorExecutionSummary `protobuf:"bytes,8,rep,name=execution_summaries" json:"execution_summaries,omitempty"`
	// It indicates the encode type of response.
	EncodeType       EncodeType `protobuf:"varint,9,opt,name=encode_type,enum=tipb.EncodeType" json:"encode_type"`
	XXX_unrecognized []byte     `json:"-"`
}
...
type DAGRequest struct {
	...
	CollectRangeCounts *bool `protobuf:"varint,6,opt,name=collect_range_counts" json:"collect_range_counts,omitempty"`
	// It indicates the maximum number of warning,
	// which is the number of messages that SHOW WARNINGS displays.
	MaxWarningCount *uint64 `protobuf:"varint,7,opt,name=max_warning_count" json:"max_warning_count,omitempty"`
	// It indicates the encode type of response.
	EncodeType EncodeType `protobuf:"varint,8,opt,name=encode_type,enum=tipb.EncodeType" json:"encode_type"`
	// It indicates the sql_mode.
	SqlMode *uint64 `protobuf:"varint,9,opt,name=sql_mode" json:"sql_mode,omitempty"`
	// supply offset is not enough since we have daylight saving time present in some regions
	TimeZoneName string `protobuf:"bytes,11,opt,name=time_zone_name" json:"time_zone_name"`
	...
	// in the response.
	CollectExecutionSummaries *bool `protobuf:"varint,12,opt,name=collect_execution_summaries" json:"collect_execution_summaries,omitempty"`
	// Represents the maximum size of one packet, any generated string, or any parameter sent as long data.
	MaxAllowedPacket *uint64 `protobuf:"varint,13,opt,name=max_allowed_packet" json:"max_allowed_packet,omitempty"`
	// Represents the chunk memory layout.
	ChunkMemoryLayout *ChunkMemoryLayout `protobuf:"bytes,14,opt,name=chunk_memory_layout" json:"chunk_memory_layout,omitempty"`
	// Represents whether the expression use RPN form.
	IsRpnExpr *bool `protobuf:"varint,15,opt,name=is_rpn_expr" json:"is_rpn_expr,omitempty"`
	...
	RootExecutor     *Executor `protobuf:"bytes,17,opt,name=root_executor" json:"root_executor,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
type UserIdentity struct {
	UserName         string `protobuf:"bytes,1,opt,name=user_name" json:"user_name"`
	UserHost         string `protobuf:"bytes,2,opt,name=user_host" json:"user_host"`
	XXX_unrecognized []byte `json:"-"`
}
...
var fileDescriptorSelect = []byte{
	...
	,
}
