...
type DAGRequest struct {
	...
	TiflashConfig    *TiflashConfig `protobuf:"bytes,19,opt,name=tiflash_config,json=tiflashConfig" json:"tiflash_config,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *DAGRequest) GetTiflashConfig() *TiflashConfig {
	if m != nil {
		return m.TiflashConfig
	}
	return nil
}
...
type TiflashConfig struct {
	ConfigMap        map[string]string `protobuf:"bytes,1,rep,name=config_map,json=configMap" json:"config_map" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_unrecognized []byte            `json:"-"`
}

func (m *TiflashConfig) Reset()                    { *m = TiflashConfig{} }
func (m *TiflashConfig) String() string            { return proto.CompactTextString(m) }
func (*TiflashConfig) ProtoMessage()               {}
func (*TiflashConfig) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{9} }

func (m *TiflashConfig) GetConfigMap() map[string]string {
	if m != nil {
		return m.ConfigMap
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TiflashConfig)(nil), "tipb.TiflashConfig")
...
func (m *DAGRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TiflashConfig != nil {
		dAtA[i] = 0x9a
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintSelect(dAtA, i, uint64(m.TiflashConfig.Size()))
		n6, err := m.TiflashConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *TiflashConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TiflashConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.ConfigMap) > 0 {
		for k, _ := range m.ConfigMap {
			dAtA[i] = 0xa
			i++
			v := m.ConfigMap[k]
			mapSize := 1 + len(k) + sovSelect(uint64(len(k))) + 1 + len(v) + sovSelect(uint64(len(v)))
			i = encodeVarintSelect(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintSelect(dAtA, i, uint64(len(k)))
			i += copy(dAtA[i:], k)
			dAtA[i] = 0x12
			i++
			i = encodeVarintSelect(dAtA, i, uint64(len(v)))
			i += copy(dAtA[i:], v)
		}
	}
	if m.XXX_unrecognized != nil {
...
func (m *TiflashConfig) Size() (n int) {
	var l int
	_ = l
	if len(m.ConfigMap) > 0 {
		for k, v := range m.ConfigMap {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovSelect(uint64(len(k))) + 1 + len(v) + sovSelect(uint64(len(v)))
			n += mapEntrySize + 1 + sovSelect(uint64(mapEntrySize))
		}
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *DAGRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TiflashConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TiflashConfig == nil {
				m.TiflashConfig = &TiflashConfig{}
			}
			if err := m.TiflashConfig.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TiflashConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TiflashConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TiflashConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.ConfigMap == nil {
				m.ConfigMap = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
...
var fileDescriptorSelect = []byte{
	...
	,
}
