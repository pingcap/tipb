...
type SelectResponse struct {
	...
	RowBatchData     github_com_pingcap_tipb_sharedbytes.SharedBytes `protobuf:"bytes,8,opt,name=row_batch_data,json=rowBatchData,customtype=github.com/pingcap/tipb/sharedbytes.SharedBytes" json:"row_batch_data"`
	XXX_unrecognized []byte                                          `json:"-"`
}
...
func (m *SelectResponse) GetVersion() int64 {
...
func (m *StreamResponse) GetVersion() int64 {
	if m != nil && m.Version != nil {
		return *m.Version
	}
	return 0
...
func (m *SelectResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Version != nil {
		dAtA[i] = 0x38
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.Version))
	}
	dAtA[i] = 0x42
	i++
...
func (m *SelectResponse) Size() (n int) {
	...
	if m.Version != nil {
		n += 1 + sovSelect(uint64(*m.Version))
	}
...
var fileDescriptorSelect = []byte{
	...
	,
}
