...
func (m *AnalyzeColumnsResp) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PkHist != nil {
		...
		n4, err := m.PkHist.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *AnalyzeIndexResp) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Hist != nil {
		...
		n5, err := m.Hist.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
	...
	if m.Collector != nil {
		...
		n7, err := m.Collector.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *SampleCollector) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FmSketch != nil {
		...
		n8, err := m.FmSketch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.CmSketch != nil {
		...
		n9, err := m.CmSketch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
