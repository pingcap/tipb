...
// HllSketch is used to estimate NDV with HyperLogLog.
type HllSketch struct {
	BucketBits uint32   `protobuf:"varint,1,opt,name=bucket_bits,json=bucketBits" json:"bucket_bits"`
	Registers  []uint32 `protobuf:"varint,2,rep,name=registers" json:"registers,omitempty"`
}
...
func (m *HllSketch) GetBucketBits() uint32 {
	if m != nil {
		return m.BucketBits
	}
	return 0
...
func (m *HllSketch) GetRegisters() []uint32 {
	if m != nil {
		return m.Registers
	}
	return nil
...
type SampleCollector struct {
	...
	HllSketch *HllSketch `protobuf:"bytes,7,opt,name=hll_sketch,json=hllSketch" json:"hll_sketch,omitempty"`
}
...
func (m *SampleCollector) GetHllSketch() *HllSketch {
	if m != nil {
		return m.HllSketch
	}
	return nil
...
type RowSampleCollector struct {
	...
	HllSketch  []*HllSketch `protobuf:"bytes,6,rep,name=hll_sketch,json=hllSketch" json:"hll_sketch,omitempty"`
}
...
var fileDescriptor_76c3eb6de5a1604f = []byte{
	...
	,
}
...
func (m *HllSketch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Registers) > 0 {
		for iNdEx := len(m.Registers) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintAnalyze(dAtA, i, uint64(m.Registers[iNdEx]))
			i--
			dAtA[i] = 0x10
		}
	}
	i = encodeVarintAnalyze(dAtA, i, uint64(m.BucketBits))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *SampleCollector) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HllSketch != nil {
		{
			size, err := m.HllSketch.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HllSketch) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovAnalyze(uint64(m.BucketBits))
	if len(m.Registers) > 0 {
...
func (m *HllSketch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BucketBits", wireType)
			}
			m.BucketBits = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BucketBits |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SampleCollector) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.HllSketch == nil {
				m.HllSketch = &HllSketch{}
			}
			if err := m.HllSketch.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
