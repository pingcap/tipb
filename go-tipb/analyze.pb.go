...
type AnalyzeReq struct {
	...
	StartTsFallback  *uint64            `protobuf:"varint,2,opt,name=start_ts_fallback" json:"start_ts_fallback,omitempty"`
...
type AnalyzeIndexReq struct {
	...
	SampleSize       int64  `protobuf:"varint,5,opt,name=sample_size" json:"sample_size"`
	SketchSize       int64  `protobuf:"varint,6,opt,name=sketch_size" json:"sketch_size"`
	XXX_unrecognized []byte `json:"-"`
}
...
type AnalyzeColumnsReq struct {
	...
	PrimaryColumnIds []int64       `protobuf:"varint,7,rep,name=primary_column_ids" json:"primary_column_ids,omitempty"`
	XXX_unrecognized []byte        `json:"-"`
}
...
type SampleCollector struct {
	...
	TotalSize        *int64    `protobuf:"varint,6,opt,name=total_size" json:"total_size,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
type CMSketch struct {
	...
	TopN             []*CMSketchTopN `protobuf:"bytes,2,rep,name=top_n" json:"top_n,omitempty"`
	DefaultValue     uint64          `protobuf:"varint,3,opt,name=default_value" json:"default_value"`
	XXX_unrecognized []byte          `json:"-"`
}
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
