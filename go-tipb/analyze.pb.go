...
type SampleCollector struct {
	...
	SampleWeights    []int64   `protobuf:"varint,7,rep,name=sample_weights,json=sampleWeights" json:"sample_weights,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
func (m *SampleCollector) GetSampleWeights() []int64 {
	if m != nil {
		return m.SampleWeights
	}
	return nil
}
...
type RowSampleCollector struct {
	...
	SampleWeights    []uint64    `protobuf:"varint,6,rep,name=sample_weights,json=sampleWeights" json:"sample_weights,omitempty"`
	XXX_unrecognized []byte      `json:"-"`
}
...
func (m *RowSampleCollector) GetSamples() [][]byte {
	if m != nil {
		return m.Samples
	}
	return nil
...
func (m *RowSampleCollector) GetNullCount() int64 {
	if m != nil {
		return m.NullCount
	}
	return 0
...
func (m *RowSampleCollector) GetSampleWeights() []uint64 {
	if m != nil {
		return m.SampleWeights
	}
	return nil
...
func (*CMSketchRow) Descriptor() ([]byte, []int) { return fileDescriptorAnalyze, []int{12} }
...
func (*CMSketchTopN) Descriptor() ([]byte, []int) { return fileDescriptorAnalyze, []int{13} }
...
func (*CMSketch) Descriptor() ([]byte, []int) { return fileDescriptorAnalyze, []int{14} }
...
func (m *SampleCollector) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SampleWeights) > 0 {
		for _, num := range m.SampleWeights {
			dAtA[i] = 0x38
			i++
			i = encodeVarintAnalyze(dAtA, i, uint64(num))
		}
	...
	for iNdEx < l {
		...
		case 7:
			if wireType == 0 {
				...
				m.SampleWeights = append(m.SampleWeights, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SampleWeights", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipAnalyze(dAtA[iNdEx:])
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
