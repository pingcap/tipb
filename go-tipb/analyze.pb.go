...
type AnalyzeColumnGroup struct {
	...
	ColumnLengths    []int64 `protobuf:"varint,2,rep,name=column_lengths,json=columnLengths" json:"column_lengths,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *AnalyzeColumnGroup) GetColumnLengths() []int64 {
	if m != nil {
		return m.ColumnLengths
	}
	return nil
}
...
func (m *AnalyzeColumnGroup) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ColumnLengths) > 0 {
		for _, num := range m.ColumnLengths {
			dAtA[i] = 0x10
			i++
			i = encodeVarintAnalyze(dAtA, i, uint64(num))
		}
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				...
				m.ColumnLengths = append(m.ColumnLengths, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field ColumnLengths", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipAnalyze(dAtA[iNdEx:])
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
