...
type AnalyzeReq struct {
	...
	IdxReq           []*AnalyzeIndexReq `protobuf:"bytes,5,rep,name=idx_req,json=idxReq" json:"idx_req,omitempty"`
...
func (m *AnalyzeIndexReq) GetIndexInfo() *IndexInfo {
	if m != nil {
		return m.IndexInfo
	}
	return nil
...
type AnalyzeResp struct {
	ColumnsResp      []*AnalyzeColumnsResp `protobuf:"bytes,1,rep,name=columns_resp,json=columnsResp" json:"columns_resp,omitempty"`
	IndexResp        []*AnalyzeIndexResp   `protobuf:"bytes,2,rep,name=index_resp,json=indexResp" json:"index_resp,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
...
func (*AnalyzeResp) Descriptor() ([]byte, []int) { return fileDescriptorAnalyze, []int{3} }

func (m *AnalyzeResp) GetColumnsResp() []*AnalyzeColumnsResp {
	if m != nil {
...
func (m *AnalyzeResp) GetIndexResp() []*AnalyzeIndexResp {
	if m != nil {
		return m.IndexResp
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AnalyzeResp)(nil), "tipb.AnalyzeResp")
...
func (m *AnalyzeReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ColReq != nil {
		...
		n1, err := m.ColReq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
...
func (m *AnalyzeIndexReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IndexInfo != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintAnalyze(dAtA, i, uint64(m.IndexInfo.Size()))
...
func (m *AnalyzeResp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AnalyzeResp) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.ColumnsResp) > 0 {
		for _, msg := range m.ColumnsResp {
			dAtA[i] = 0xa
			i++
			i = encodeVarintAnalyze(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.IndexResp) > 0 {
		for _, msg := range m.IndexResp {
			dAtA[i] = 0x12
			i++
			i = encodeVarintAnalyze(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *AnalyzeResp) Size() (n int) {
	var l int
	_ = l
	if len(m.ColumnsResp) > 0 {
		for _, e := range m.ColumnsResp {
			l = e.Size()
			n += 1 + l + sovAnalyze(uint64(l))
		}
	}
	if len(m.IndexResp) > 0 {
		for _, e := range m.IndexResp {
			l = e.Size()
			n += 1 + l + sovAnalyze(uint64(l))
		}
	}
...
func (m *AnalyzeReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.IdxReq = append(m.IdxReq, &AnalyzeIndexReq{})
			if err := m.IdxReq[len(m.IdxReq)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *AnalyzeResp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AnalyzeResp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AnalyzeResp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.ColumnsResp = append(m.ColumnsResp, &AnalyzeColumnsResp{})
			if err := m.ColumnsResp[len(m.ColumnsResp)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.IndexResp = append(m.IndexResp, &AnalyzeIndexResp{})
			if err := m.IndexResp[len(m.IndexResp)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
