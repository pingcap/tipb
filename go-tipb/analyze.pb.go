...
type AnalyzeColumnsReq struct {
	...
	SampleRate       *int32 `protobuf:"varint,11,opt,name=sample_rate,json=sampleRate" json:"sample_rate,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (m *AnalyzeColumnsReq) GetSampleRate() int32 {
...
func (m *AnalyzeColumnsReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SampleRate != nil {
		dAtA[i] = 0x58
		i++
		i = encodeVarintAnalyze(dAtA, i, uint64(*m.SampleRate))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *AnalyzeColumnsReq) Size() (n int) {
	...
	if m.SampleRate != nil {
		n += 1 + sovAnalyze(uint64(*m.SampleRate))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
