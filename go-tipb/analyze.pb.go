...
type HLLSketch struct {
	B         uint32 `protobuf:"varint,1,opt,name=b" json:"b"`
	Registers []byte `protobuf:"bytes,2,opt,name=registers" json:"registers,omitempty"`
}
...
type RowSampleCollector struct {
	...
	F1Sketch          []*FMSketch  `protobuf:"bytes,6,rep,name=f1_sketch,json=f1Sketch" json:"f1_sketch,omitempty"`
	SketchSampleCount int64        `protobuf:"varint,7,opt,name=sketch_sample_count,json=sketchSampleCount" json:"sketch_sample_count"`
	HllSketch         []*HLLSketch `protobuf:"bytes,8,rep,name=hll_sketch,json=hllSketch" json:"hll_sketch,omitempty"`
	HllF1Sketch       []*HLLSketch `protobuf:"bytes,9,rep,name=hll_f1_sketch,json=hllF1Sketch" json:"hll_f1_sketch,omitempty"`
}
...
func (m *RowSampleCollector) GetF1Sketch() []*FMSketch {
	if m != nil {
		return m.F1Sketch
	}
	return nil
...
func (m *RowSampleCollector) GetHllSketch() []*HLLSketch {
	if m != nil {
		return m.HllSketch
	}
	return nil
...
func (m *RowSampleCollector) GetHllF1Sketch() []*HLLSketch {
	if m != nil {
		return m.HllF1Sketch
	}
	return nil
}
...
var fileDescriptor_76c3eb6de5a1604f = []byte{
	...
	,
}
...
func (m *HLLSketch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i = encodeVarintAnalyze(dAtA, i, uint64(m.B))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *RowSampleCollector) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.HllF1Sketch) > 0 {
		for iNdEx := len(m.HllF1Sketch) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.HllF1Sketch[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.HllSketch) > 0 {
		for iNdEx := len(m.HllSketch) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.HllSketch[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	dAtA[i] = 0x38
	if len(m.F1Sketch) > 0 {
		for iNdEx := len(m.F1Sketch) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.F1Sketch[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *RowSampleCollector) Size() (n int) {
	...
	if len(m.HllSketch) > 0 {
		for _, e := range m.HllSketch {
			l = e.Size()
			n += 1 + l + sovAnalyze(uint64(l))
		}
	}
	if len(m.HllF1Sketch) > 0 {
		for _, e := range m.HllF1Sketch {
			l = e.Size()
			n += 1 + l + sovAnalyze(uint64(l))
		}
	}
...
func (m *RowSampleCollector) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field F1Sketch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.F1Sketch = append(m.F1Sketch, &FMSketch{})
			if err := m.F1Sketch[len(m.F1Sketch)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
		...
		case 8:
			...
			m.HllSketch = append(m.HllSketch, &HLLSketch{})
			if err := m.HllSketch[len(m.HllSketch)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HllF1Sketch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HllF1Sketch = append(m.HllF1Sketch, &HLLSketch{})
			if err := m.HllF1Sketch[len(m.HllF1Sketch)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
