...
type AnalyzeColumnsReq struct {
	...
	IdxReq           []*AnalyzeIndexReq `protobuf:"bytes,8,rep,name=idx_req,json=idxReq" json:"idx_req,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}
...
func (m *AnalyzeColumnsReq) GetIdxReq() []*AnalyzeIndexReq {
	if m != nil {
		return m.IdxReq
	}
	return nil
...
type AnalyzeColumnsResp struct {
	...
	IdxResp          []*AnalyzeIndexResp `protobuf:"bytes,8,rep,name=idx_resp,json=idxResp" json:"idx_resp,omitempty"`
	XXX_unrecognized []byte              `json:"-"`
}
...
func (m *AnalyzeColumnsResp) GetIdxResp() []*AnalyzeIndexResp {
	if m != nil {
		return m.IdxResp
	}
	return nil
...
func (m *AnalyzeColumnsResp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IdxResp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IdxResp = append(m.IdxResp, &AnalyzeIndexResp{})
			if err := m.IdxResp[len(m.IdxResp)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
