...
type SampleCollector struct {
	...
	TotColSize       *int64    `protobuf:"varint,6,opt,name=tot_col_size,json=totColSize" json:"tot_col_size,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}
...
func (m *SampleCollector) GetTotColSize() int64 {
	if m != nil && m.TotColSize != nil {
		return *m.TotColSize
	}
	return 0
}
...
func (m *SampleCollector) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TotColSize != nil {
		dAtA[i] = 0x30
		i++
		i = encodeVarintAnalyze(dAtA, i, uint64(*m.TotColSize))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *SampleCollector) Size() (n int) {
	...
	if m.TotColSize != nil {
		n += 1 + sovAnalyze(uint64(*m.TotColSize))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *SampleCollector) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotColSize", wireType)
			}
			var v int64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
