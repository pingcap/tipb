...
func (dst *DumpBinlogReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DumpBinlogReq.Merge(dst, src)
}
...
func (dst *DumpBinlogResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DumpBinlogResp.Merge(dst, src)
}
...
func (dst *DumpDDLJobsReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DumpDDLJobsReq.Merge(dst, src)
}
...
func (dst *DumpDDLJobsResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DumpDDLJobsResp.Merge(dst, src)
}
...
func (dst *NotifyResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NotifyResp.Merge(dst, src)
}
