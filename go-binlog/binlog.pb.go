...
func (dst *TableMutation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TableMutation.Merge(dst, src)
}
...
func (dst *PrewriteValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrewriteValue.Merge(dst, src)
}
